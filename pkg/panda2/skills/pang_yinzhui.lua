...
[":pang_yinzhui"] = "转换技，当你使用或打出一张牌后，①你可以令当前回合角色摸两张牌或本回合手牌上限+1②你可以令当前回合角色弃置两张牌或本回合手牌上限-1。",

[":pang_yinzhui_yang"] = "转换技，当你使用或打出一张牌后，<font color=\"#E0DB2F\">①你可以令当前回合角色摸两张牌或本回合手牌上限+1</font>" ..
"②你可以令当前回合角色弃置两张牌或本回合手牌上限-1。",
[":pang_yinzhui_yin"] = "转换技，当你使用或打出一张牌后，①你可以令当前回合角色摸两张牌或本回合手牌上限+1"..
"<font color=\"#E0DB2F\">②你可以令当前回合角色弃置两张牌或本回合手牌上限-1</font>。",
