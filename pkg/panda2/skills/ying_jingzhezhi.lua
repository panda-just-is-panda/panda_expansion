Fk:loadTranslationTable{
    ...
    [":ying_jingzhezhi_yang"] = "转换技，出牌阶段限一次，你可以选择一名角色，然后你弃置所有手牌（无牌则不弃）并视为使用一张【万箭齐发】；当此牌造成伤害时，其防止此伤害并<font color=\"#E0DB2F\">①重铸</font>②摸一张牌。",
    [":ying_jingzhezhi_yin"] = "转换技，出牌阶段限一次，你可以选择一名角色，然后你弃置所有手牌（无牌则不弃）并视为使用一张【万箭齐发】；当此牌造成伤害时，其防止此伤害并①重铸<font color=\"#E0DB2F\">②摸</font>一张牌。",
