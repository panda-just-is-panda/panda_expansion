  ...
  on_use = function(self, event, target, player, data)
    ...
    if #cards > 0 then
      ...
      local discards = table.filter(player:getCardIds("he"), function(id)
        ...
        return card and card.color == card.Black and not player:prohibitDiscard(id)
      end)
      if #discards > 0 then
...
["#pang_binghai"] = "你可以摸两张牌并弃置所有非红色牌",
  ...
  ["$pang_binghai1"] = "It's time for a little party? Huh huh, I am coming over.",
  ["$pang_binghai2"] = "I'm sending over now.",
}
